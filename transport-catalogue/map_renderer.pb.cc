...
const uint32_t TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.height_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.padding_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.line_width_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.stop_radius_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.bus_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.bus_label_offset_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.stop_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.stop_label_offset_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.underlayer_color_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.underlayer_width_),
  PROTOBUF_FIELD_OFFSET(::transport_catalog_serialize::MapSettings, _impl_.color_palette_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::transport_catalog_serialize::MapSettings)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::transport_catalog_serialize::_MapSettings_default_instance_._instance,
};

const char descriptor_table_protodef_map_5frenderer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022map_renderer.proto\022\033transport_catalog_"
  "serialize\032\tsvg.proto\"\261\003\n\013MapSettings\022\r\n\005"
  "width\030\001 \001(\001\022\016\n\006height\030\002 \001(\001\022\017\n\007padding\030\003"
  " \001(\001\022\022\n\nline_width\030\004 \001(\001\022\023\n\013stop_radius\030"
  "\005 \001(\001\022\033\n\023bus_label_font_size\030\006 \001(\r\022<\n\020bu"
  "s_label_offset\030\007 \001(\0132\".transport_catalog"
  "_serialize.Point\022\034\n\024stop_label_font_size"
  "\030\010 \001(\r\022=\n\021stop_label_offset\030\t \001(\0132\".tran"
  "sport_catalog_serialize.Point\022<\n\020underla"
  "yer_color\030\n \001(\0132\".transport_catalog_seri"
  "alize.Color\022\030\n\020underlayer_width\030\013 \001(\001\0229\n"
  "\rcolor_palette\030\014 \003(\0132\".transport_catalog"
  "_serialize.Colorb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_map_5frenderer_2eproto = {
    false, false, 504, descriptor_table_protodef_map_5frenderer_2eproto,
    "map_renderer.proto",
...
class MapSettings::_Internal {
 public:
  static const ::transport_catalog_serialize::Point& bus_label_offset(const MapSettings* msg);
  static const ::transport_catalog_serialize::Point& stop_label_offset(const MapSettings* msg);
  static const ::transport_catalog_serialize::Color& underlayer_color(const MapSettings* msg);
};

const ::transport_catalog_serialize::Point&
...
void MapSettings::clear_stop_label_offset() {
...
MapSettings::MapSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:transport_catalog_serialize.MapSettings)
}
MapSettings::MapSettings(const MapSettings& from)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::transport_catalog_serialize::Point(*from._impl_.bus_label_offset_);
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_impl_.stop_label_offset_ = new ::transport_catalog_serialize::Point(*from._impl_.stop_label_offset_);
  }
  if (from._internal_has_underlayer_color()) {
    _this->_impl_.underlayer_color_ = new ::transport_catalog_serialize::Color(*from._impl_.underlayer_color_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:transport_catalog_serialize.MapSettings)
}
...
MapSettings::~MapSettings() {
  // @@protoc_insertion_point(destructor:transport_catalog_serialize.MapSettings)
...
// @@protoc_insertion_point(message_clear_start:transport_catalog_serialize.MapSettings)
...
uint8_t* MapSettings::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:transport_catalog_serialize.MapSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:transport_catalog_serialize.MapSettings)
  return target;
}

size_t MapSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:transport_catalog_serialize.MapSettings)
  size_t total_size = 0;
...
void MapSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:transport_catalog_serialize.MapSettings)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::transport_catalog_serialize::Point::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::transport_catalog_serialize::Point::MergeFrom(
        from._internal_stop_label_offset());
  }
  if (from._internal_has_underlayer_color()) {
    _this->_internal_mutable_underlayer_color()->::transport_catalog_serialize::Color::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:transport_catalog_serialize.MapSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::transport_catalog_serialize::MapSettings*
Arena::CreateMaybeMessage< ::transport_catalog_serialize::MapSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::transport_catalog_serialize::MapSettings >(arena);
}
